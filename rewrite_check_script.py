inhoud = '''from regime_orchestrator import RegimeOrchestrator
...
with open("/root/hbar_bot/check_position_76712_v2.py", "w") as f:
    f.write(inhoud)
print("Bestand rechtstreeks, schoon herschreven.")
