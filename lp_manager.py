...
class LpManager:
    ...
    def compute_needed_usdc_for_hbar(self, hbar_raw: int, price: float,
    ...
    def open_position(self, amount0_desired: int, amount1_desired: int,
        ...
        # BUGFIX (4 sep 2026, KRITIEK, gevonden na herhaalde live
    ...
    def deploy_additional_capital(self, token_id: int, amount0_desired: int, amount1_desired: int,
        ...
        # BUGFIX (6 sep 2026, empirisch bevestigd via een live-test):
